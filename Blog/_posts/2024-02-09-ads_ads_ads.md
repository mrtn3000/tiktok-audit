...
{% include figure.html path="/assets/img/2023-02_tt_ad_label_example.png" caption="Example of an advertising label on TikTok in Germany. 'Anzeige' is German for 'Advertising'. On the English app version, the videos are labeled as 'Sponsored.'" class="img-fluid rounded z-depth-1" zoomable=true width="100%" %} 
...
**Combined with the paid promtions, for the accounts trained in fashion, roughly one of three videos is an ad.** 
